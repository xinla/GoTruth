<template>
  <div class="feedback-wrap">
    ...
    <!-- 常见问题 -->
    <div class="feedback-tab feedback-question" v-show="nowIndex===1" ref="wrapper">
      <div>
        ...
        <div class="question-body">
          <ul class="question-list">
            ...
            <li class="question-item">
              ...
              <p class="anwser">答：关于真相号使用相关问题，您可以在在真相号后台“客户服务”一栏查看，或联系客服 QQ：2787064791 反馈相关问题。</p>
            </li>
            <li class="question-item">
            ...
            <li class="question-item">
              ...
              <p class="anwser">答：本地新闻在您可以在顶部导航栏中点击您当前所在城市，如果您的顶部导航栏中找不到本地频道，可以搜索指定城市并订阅。同时，进入本地频道后，页面右上角的「切换城市」按钮可以支持城市之间的切换。</p>
            </li>
          </ul>
        </div>
      </div>
